...
static const char col_cyan[]        = "#4b964b";    //"#f59542";
...
static const char *chgil[] = {"setxkbmap", "il", NULL};
static const char *chgus[] = {"setxkbmap", "us", NULL};
//static char *lnchalsa = {"/usr/local/bin/st", "-e", "alsamixer", NULL };
//static const char *lnchalsa = {"st -e alsamixer", NULL };
...
static Key keys[] = {
    ...
    //	{ MODKEY,			XK_a,	   spawn,	   {.v = lnchalsa } },
    //{ ControlMask, 			ShiftMask, spawn,	{.v = chgil } },
    //{ Mod1Mask,				ShiftMask, spawn, 	{.v = chgus } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
